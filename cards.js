var cards = [
  ...
  new Card("Alden", "Camelot", 5, "", 50, 8022, 2341, ["Elemental Uprising","Frozen Core",]),
  ...
  new Card("Ben-nu Fireborn", "Druid", 5, 16, 50, 7409, 2269, ["Undying","Regeneration","Fire Breathing","Mythic Creatures","Immortals","Burning Wrath","Phoenix Fury",]),
  new Card("Ben-nu Frostborn", "Druid", 5, 20, 50, 11223, 2213, ["Phoenix Fury","Frozen Terrors","Frozen Core",]),
  new Card("Ben-nu Hellborn", "Camelot", 6, 27, 60, 12875, 3144, ["Phoenix Fury","Aerial Doom","Hell's Terror",]),
  new Card("Ben-nu Skyborn", "Druid", 5, "", 50, 10452, 2765, ["Phoenix Fury","Fury of the Skies",]),
  new Card("Berserker", "Druid", 4, "", 40, 4740, 1776, ["Bruisers","Brute Force","Tribal Fury","Furious Fighters",]),
  new Card("Black Knight", "Demon", 4, "", 40, 4320, 1368, ["Twin Knights","Enigmatic Knights","Generals","Black Riders",]),
  ...
  new Card("Bourgard", "Demon", 4, "", 40, 4320, 1368, ["King Size Weapons","Hooded Terrors","Body Count","Undead Army",]),
  new Card("Brew Master", "Druid", 4, "", 40, 5021, 1512, ["Crazed Stupor",]),
  new Card("Butcher of Princes", "Demon", 5, "", 50, 9999, 2222, ["Body Count",]),
  new Card("Caradd the Gale", "Druid", 5, 14, 50, 6456, 1992, ["Nature's Wrath","Elemental Fury","Fury of the Skies","Thunder's Fury",]),
  new Card("Cardon", "Camelot", 5, "", 50, 7851, 2987, ["Cruel Strike",]),
  new Card("Celadon Dragonaire", "Camelot", 5, "", 50, 9911, 2459, ["Draconic Legion","Frozen Core",]),
  ...
  new Card("Death", "Demon", 6, 29, 60, 12830, 2780, ["Four Horsemen","Pure Evil","Opposite Ends","Black Riders","Hell's Terror","Soul Eaters",]),
  ...
  new Card("Dream Eater", "Demon", 5, "", 50, 8440, 2612, ["Death Whisper",]),
  ...
  new Card("Drust Mac Erp", "Druid", 6, 25, 60, 11930, 3380, ["Champions","Savage Elite","Ultimate Fighters",]),
  ...
  new Card("Ember Druid", "Druid", 3, 9, 30, 3445, 1080, ["Magicians","Burning Wrath","Flame Strike",]),
  ...
  new Card("Flame Witch", "Camelot", 4, "", 40, 5891, 1780, ["Elemental Uprising","Flame Strike",]),
  ...
  new Card("Gargoyle", "Demon", 5, "", 50, 6751, 2314, ["Death Whisper","Undead Army",]),
  new Card("Gawain's Guard", "Camelot", 5, 16, 50, 7852, 2018, ["Royal Bodyguards","Lords and Guards","Disciplined",]),
  new Card("Gaznar Soulripper", "Demon", 5, 16, 50, 6754, 2105, ["2013 All Stars","Relentless Evil","Unholy Strength","Monster Mash","Aerial Doom","Pure Evil","Opposite Ends",]),
  ...
  new Card("Godfrey One-Arm", "Camelot", 6, "", 60, 12599, 3551, ["Cruel Strike","The Wartorn",]),
  ...
  new Card("Hudde", "Camelot", 5, "", 50, 8899, 2233, ["The Wartorn",]),
  new Card("Hugues de Payns", "Camelot", 6, "", 60, 11251, 3677, ["Sacred Squadron",]),
  ...
  new Card("Kel Earthbringer", "Druid", 6, 20, 60, 11330, 3480, ["Strength of Will","Geomancers","Elemental Uprising",]),
  ...
  new Card("Maiden of the Order", "Camelot", 5, "", 50, 8899, 2311, ["The Wartorn",]),
  ...
  new Card("Mason", "Camelot", 5, "", 50, 7891, 2051, ["Cruel Strike","Furious Fighters",]),
  ...
  new Card("Night Rider", "Demon", 5, "", 50, 8888, 2222, ["Black Riders","Hell's Terror",]),
  ...
  new Card("Paladin", "Camelot", 4, 12, 40, 5650, 1376, ["Twin Knights","Suited Up","Holy Men","Healers","Knight Warband","Assault Team","Sacred Squadron",]),
  ...
  new Card("Shiverheart", "Demon", 6, "", 60, 12930, 3080, ["Frozen Terrors","Pet Familiars","Frozen Core",]),
  new Card("Sir Galahad", "Camelot", 6, 19, 60, 11240, 2640, ["Suited Up","Elite Force","Lords and Guards","Fearless Fighters","Champions",]),
  new Card("Sir Kay", "Camelot", 5, 15, 50, 7552, 1818, ["Suited Up","Hot Blooded","Fearless Fighters",]),
  new Card("Sir Percival", "Camelot", 6, "", 60, 12778, 3025, ["Sacred Squadron",]),
  ...
  new Card("Soul Cage", "Demon", 6, 25, 60, 11830, 2810, ["Death Whisper","Soul Eaters",]),
  ...
  new Card("Stormcaller", "Druid", 4, 12, 40, 5185, 1616, ["Elite Casters","Burst Damage","Elemental Uprising",]),
  new Card("Sun Mage", "Druid", 4, 13, 40, 5546, 1429, ["Raw Firepower","Nature Magic","Inner Circle","Flame Strike",]),
  ...
  new Card("The Butcher", "Demon", 4, "", 40, 6012, 1502, ["Undead Army",]),
  ...
  new Card("Tomb Reaver", "Demon", 5, 20, 50, 9051, 1895, ["Death Whisper","Undead Army",]),
  new Card("Totem Guard", "Druid", 6, 22, 60, 10857, 3265, ["Druid Elite","Brute Force","King Size Weapons","Enchanted Weapons","Final Stand","Champions",]),
  ...
  new Card("Treekin", "Druid", 5, 17, 50, 7885, 2408, ["Nature's Wrath","Living Forest",]),
  new Card("Treekin Shaman", "Druid", 5, 16, 50, 8065, 1944, ["Living Forest","Theurgists","Nature Magic",]),
  ...
  new Card("Veteran Paladin", "Camelot", 6, 23, 60, 10857, 3565, ["Jack of all Trades","Augmented Arms","Hot Blooded","The Wartorn","Sacred Squadron","Paragons of War","Battleborn",]),
  ...
  new Card("Wild Huntress", "Druid", 4, "", 40, 5122, 1351, ["Furious Fighters","Crazed Stupor",]),
  new Card("Winter Treekin", "Druid", 4, 15, 40, 5440, 1712, ["Polar",]),
  new Card("Woman of Windsor", "Druid", 4, "", 40, 5021, 1512, ["Crazed Stupor",]),
