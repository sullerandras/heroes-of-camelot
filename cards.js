var cards = [
  ...
  new Card("Apprentice", "Camelot", 1, "", 10, 1200, 285, ["Druid Warriors",]),
  ...
  new Card("Balzathor", "Red", 5, "", 50, 6316, 1974, ["Relentless Evil","Demons",]),
  ...
  new Card("Black Knight", "Red", 4, "", 40, 4320, 1368, ["Twin Knights",]),
  ...
  new Card("Druid Initiate", "Druid", 1, 3, 10, 765, 245, ["Druid Warriors",]),
  ...
  new Card("Father Maleficent", "Red", 4, 10, "", 3500, 1110, ["Cultists","Twin Clerics",]),
  new Card("Fenric Gore-Claw", "Red", 5, 13, 50, 5440, 1712, ["Demons",]),
  ...
  new Card("Gaznar Soulripper", "Red", 5, "", 50, 6754, 2105, ["2013 All Stars","Relentless Evil","Unholy Strength","Monster Mash",]),
  ...
  new Card("Khufu", "Red", 5, "", 50, 7600, 2546, ["Monster Mash",]),
  ...
  new Card("Longbowman", "Camelot", 2, 6, 20, 2070, 500, []),
  ...
  new Card("Modron", "Red", 5, "", 50, 4731, 1871, ["Monster Mash",]),
  new Card("Morbius the Cursed", "Red", 5, "", 50, 5878, 1843, ["Relentless Evil","Unholy Strength",]),
  ...
  new Card("Necros the Grim", "Red", 4, 12, 40, 4734, 1491, ["Cultists",]),
  new Card("Ossion the Dread", "Red", 5, "", 50, 9373, 2873, ["Relentless Evil",]),
  ...
  new Card("Psycho Butterfly", "Druid", 4, "", 40, 4748, 1480, ["Giant Insects",]),
  ...
  new Card("Trahern", "Red", 4, "", 40, 6124, 1973, ["Monster Mash",]),
  ...
  new Card("Water Nymph", "Druid", 1, 5, 10, 1360, 430, []),
  new Card("Wild Hunt", "Druid", 3, "", 30, 3840, 1202, ["Stag Herder",]),
  new Card("Winter Treekin", "Druid", 4, "", 40, 5440, 1712, ["Polar",]),
  new Card("Wood Nymph", "Druid", 1, 4, 10, 1050, 340, ["Tide Lurkers",]),
  new Card("Ysbadden", "Druid", 4, "", 40, 4740, 1480, ["Titans",]),
  new Card("Yzabel the Fallen", "Red", 5, "", 50, 7630, 2367, ["Twin Sisters",]),
];
