var cards = [
  ...
  new Card("Ageless Scorpion", "Druid", 5, "", 50, 8085, 2508, ["Desert Guardians","Goliaths","Toxic Death",]),
  ...
  new Card("Amythestine", "Druid", 5, "", 50, 6754, 2105, ["Umbral Spirits",]),
  ...
  new Card("Cernunnos", "Druid", 5, "", 50, 7740, 1863, ["Umbral Spirits","Stag Pack",]),
  ...
  new Card("Druantia", "Druid", 6, "", 60, 11336, 3415, ["Woodland Deities","Nature Magic","Immortals","Wise Sages",]),
  ...
  new Card("Famine", "Demon", 5, "", 50, 9600, 2546, ["Four Horsemen","Beyond Redemption",]),
  ...
  new Card("Green Knight", "Camelot", 6, "", 60, 11240, 2640, ["Enigmatic Knights","Cold Killers","Cunning Foes","Shining Armor","Crack Knights",]),
  new Card("Gryphon", "Camelot", 4, 10, 40, 4686, 1138, ["Hybrid Beasts",]),
  new Card("Guardian Angel", "Camelot", 5, "", 50, 6600, 1550, ["Divine Intervention","Celestials","Blessed Knight Rider","Blessed Stag Rider","Merciful Angels",]),
  ...
  new Card("Ironbark Overlord", "Druid", 6, "", 50, 10306, 3105, ["Living Forest","Unstoppable Force",]),
  new Card("Jezebel the Fair", "Camelot", 5, "", 50, 7036, 1694, ["Fallen Heroes",]),
  ...
  new Card("Kel Earthbringer", "Druid", 6, "", 60, 11330, 3480, ["Strength of Will","Geomancers",]),
  ...
  new Card("Lady of the Lake", "Camelot", 5, "", 50, 7036, 1694, ["Divine Ladies","Female Legends","Blessings of Fate",]),
  ...
  new Card("Mara of the Sand", "Druid", 6, "", 60, 11330, 4013, ["Geomancers","Inner Circle","Desert Guardians",]),
  ...
  new Card("Mhor the Wyrm", "Druid", 5, "", 50, 6933, 2130, ["Thick Hides","Epic Serpents","Titans","Wyrm Duo","Unstoppable Force","Goliaths",]),
  new Card("Mist Stalker", "Druid", 5, "", 50, 7885, 2408, ["Cold Killers","Hooded Terrors","Killers for Hire","Assassin's Alliance",]),
  ...
  new Card("Pestilence", "Demon", 5, "", 50, 9877, 2524, ["Four Horsemen","Toxic Death","Body Count",]),
  new Card("Phantom Panther", "Druid", 4, "", 40, 5200, 1711, ["On the Hunt","Feral Pack",]),
  new Card("Pikeman", "Camelot", 2, 5, 20, 1700, 415, ["Soldiers",]),
  new Card("Primal Rider", "Druid", 5, "", 50, 7392, 2436, ["Druid Elite","Heavy Cavalry","Savage Elite",]),
  ...
  new Card("Rogue Outlaw", "Camelot", 5, "", 50, 9013, 2480, ["Jack of all Trades","Free Spirits","Killers for Hire",]),
  ...
  new Card("Sir Galahad", "Camelot", 6, "", 60, 11240, 2640, ["Suited Up","Elite Force","Lords and Guards","Fearless Fighters","Champions",]),
  ...
  new Card("Stone Fist", "Druid", 5, "", 50, 5440, 2140, ["2013 All Stars","Bruisers","Brute Force","Tribal Fury","Savage Elite","Rock and Troll",]),
  ...
  new Card("Terraheart", "Demon", 5, "", 50, 9141, 1865, ["Earthen Might","Core Dwellers","Geomancers","Desert Guardians",]),
  new Card("The Horned Lord", "Druid", 5, 13, 50, 5980, 1852, ["Gods","Forest Guardians","Shamans","Theurgists","Stag Pack",]),
  new Card("The Prophet", "Camelot", 5, "", 50, 6600, 1550, ["Mystics","Cunning Foes","Wise Sages","Premeditation",]),
  ...
  new Card("Treehound", "Druid", 6, "", 50, 10857, 3265, ["Living Forest","Cold Killers","Cunning Foes",]),
  ...
  new Card("Vambrael", "Camelot", 6, "", 60, 11830, 2780, ["Divine Intervention","Gods and Heroes","Gods","Celestials","Elite Force","Righteous Fury",]),
