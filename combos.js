var combos = [
  ...
  new Combo("Battleborn", "Passive - Raise team's ATK by 75%, Skill proc +15%", ["Veteran Paladin","Weapon Master","Blademaster","War Drummer",]),
  ...
  new Combo("Black Riders", "Remove 90% of enemy team's current HP", ["Night Rider","Black Knight","Death",]),
  ...
  new Combo("Crazed Stupor", "Passive - Raise team's ATK by 50%", ["Wild Huntress","Brew Master","Woman of Windsor",]),
  new Combo("Cruel Strike", "Increase ATK by 150% when HP falls below 30%", ["Cardon","Godfrey One-Arm","Mason",]),
  ...
  new Combo("Death Whisper", "Increase ATK by 300% when HP falls below 10%", ["Soul Cage","Tomb Reaver","Gargoyle","Dream Eater",]),
  ...
  new Combo("Elemental Uprising", "Increase Skill Proc by 10%", ["Alden","Flame Witch","Stormcaller","Kel Earthbringer",]),
  ...
  new Combo("Flame Strike", "Remove 50% of enemy team's current HP", ["Flame Witch","Sun Mage","Ember Druid",]),
  ...
  new Combo("Frozen Core", "Increase Skill Proc by 10%", ["Alden","Celadon Dragonaire","Ben-nu Frostborn","Shiverheart",]),
  new Combo("Frozen Terrors", "Remove 50% of enemy team's current HP", ["Shiverheart","Ben-nu Frostborn","Ice Mage",]),
  new Combo("Furious Fighters", "Increase ATK by 200% when HP falls below 20%", ["Mason","Berserker","Wild Huntress",]),
  ...
  new Combo("Hell's Terror", "Passive - Raise team's HP by 100%, Reduce damage by 20%", ["Death","Night Rider","Ben-nu Hellborn",]),
  ...
  new Combo("Paragons of War", "Passive - Raise team's ATK by 175%", ["War","Weapon Master","Veteran Paladin",]),
  new Combo("Patriots", "Passive - Raise team's ATK by 74%", ["Bald Eagle","Grillmaster",]),
  new Combo("Pet Familiars", "Remove 80% of enemy team's current HP", ["Moira","Arcane Archer","Balzathor","Shiverheart",]),
  ...
  new Combo("Sacred Squadron", "Passive - Raise team's HP and ATK by 150%", ["Sir Percival","Veteran Paladin","Hugues de Payns","Paladin",]),
  ...
  new Combo("Soul Eaters", "Chance to revive team with 50% HP upon death", ["Death","Soul Cage",]),
  ...
  new Combo("The Wartorn", "Chance to revive team with 80% HP upon death", ["Hudde","Maiden of the Order","Veteran Paladin","Godfrey One-Arm",]),
  ...
  new Combo("Undead Army", "Passive - Raise team's HP by 125%", ["The Butcher","Bourgard","Gargoyle","Tomb Reaver",]),
